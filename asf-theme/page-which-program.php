...
<main id="main-content">
  ...
  <div class="page-hero">
    ...
    <p class="page-hero-tagline">Answer a few quick questions &mdash; we'll help you find the perfect fit</p>
  </div>

  <!-- Intro -->
  <div class="finder-intro">
    <p>We offer programs for every age, skill level, and goal &mdash; from toddler tumbling to national competition. Use the filters below to narrow down your options, or scroll to browse everything we offer.</p>
  </div>
  ...
  <div class="finder-filters">
    <div class="filter-group">
      ...
      <div class="filter-chips" data-filter="age">
        ...
        <button class="chip" data-val="toddler">2&ndash;4 years</button>
        <button class="chip" data-val="young">5&ndash;7 years</button>
        <button class="chip" data-val="child">8&ndash;12 years</button>
  ...
  <div class="prog-grid" id="prog-grid">
    ...
    <div class="prog-card" data-age="toddler young child teen" data-exp="first some regular" data-goal="fun skills">
      ...
      <div class="prog-card-body">
        ...
        <p class="prog-desc">Our weekly classes are the perfect starting point for any child. From Parent &amp; Tot for toddlers to advanced recreational levels, every class is skill-focused, fun, and confidence-building. No prior experience needed &mdash; enroll anytime throughout the year.</p>
        ...
        <a href="recreational-classes" class="prog-link">View Recreational Classes <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M5 12h14M12 5l7 7-7 7"/></svg></a>
      </div>
    </div>
    ...
    <div class="prog-card" data-age="young child teen" data-exp="first some regular" data-goal="fun">
      ...
      <div class="prog-card-body">
        ...
        <p class="prog-desc">Week-long day camps over Summer, Winter, and March Break. A high-energy mix of gymnastics, games, and activities led by our coaching staff. A great way to try gymnastics for the first time &mdash; or for current gymnasts to keep skills sharp during breaks.</p>
        ...
        <a href="camp" class="prog-link">View Camps <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M5 12h14M12 5l7 7-7 7"/></svg></a>
      </div>
    </div>
    ...
    <div class="prog-card" data-age="young child teen" data-exp="some regular" data-goal="skills">
      ...
      <div class="prog-card-body">
        ...
        <div class="prog-meta">
          ...
          <span class="prog-meta-item">
            <svg width="12" height="12" viewBox="0 0 24 24" fill="currentColor"><path d="M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zm.01 18c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8zm.5-13H11v6l5.25 3.15.75-1.23-4.5-2.67V7z"/></svg>
            3.5&ndash;7 hrs/week
          </span>
        </div>
        <p class="prog-desc">A bridge between recreational and competitive gymnastics &mdash; more structured training, without the pressure of competition. Showcase Xcel athletes develop polished routines and advanced skills in a focused environment. Entry is based on a coach assessment.</p>
        ...
        <a href="xcel" class="prog-link">View Xcel / Advanced <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M5 12h14M12 5l7 7-7 7"/></svg></a>
      </div>
    </div>
    ...
    <div class="prog-card" data-age="child teen" data-exp="regular" data-goal="skills compete">
      ...
      <div class="prog-card-body">
        ...
        <p class="prog-desc">Train and compete through defined Xcel levels &mdash; Bronze, Silver, Gold, and Platinum. Athletes participate in regional meets with structured judging, working toward higher levels over time. A rewarding competition pathway that doesn't require Olympic-level hours.</p>
    ...
    <div class="prog-card" data-age="young child" data-exp="some regular" data-goal="compete">
      ...
      <div class="prog-card-body">
        ...
        <a href="competitive-team" class="prog-link">View Competitive Team <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M5 12h14M12 5l7 7-7 7"/></svg></a>
      </div>
    </div>
    ...
    <div class="prog-card" data-age="child teen" data-exp="regular" data-goal="compete">
      ...
      <div class="prog-card-body">
        ...
        <div class="prog-meta">
          ...
          <span class="prog-meta-item">
            <svg width="12" height="12" viewBox="0 0 24 24" fill="currentColor"><path d="M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zm.01 18c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8zm.5-13H11v6l5.25 3.15.75-1.23-4.5-2.67V7z"/></svg>
            12&ndash;20+ hrs/week
          </span>
        </div>
        <p class="prog-desc">The main competitive stream at ASF. Athletes progress through OCP Levels 1&ndash;9 and compete at provincial championships. This program develops well-rounded gymnasts with strong technique and the discipline to compete at a high level year after year.</p>
  ...
  <div class="no-results" id="no-results">
    <div class="no-results-inner">
      <h3>No exact match &mdash; let's chat</h3>
      <p>Every child is different, and sometimes the best fit isn't obvious on paper. Reach out to us and we'll help you figure it out &mdash; we're happy to answer questions or arrange a free assessment.</p>
  ...
  <div class="birthday-callout">
    ...
    <div>
      ...
      <p>Celebrate your child's big day with an action-packed gymnastics party at ASF. Available Sundays from September to June &mdash; open to all families, no enrollment required.</p>
      <a href="birthday" class="btn-red">See Birthday Packages</a>
    </div>
  </div>
